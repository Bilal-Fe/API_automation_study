...
//        assertEquals("Checkout date is not matching","2021-05-07", json.getString("bookingdates.checkout"));
        ...
        softAssert.assertEquals( json.getString("lastname"), "Wilson", "Last name is not matching"  );
        softAssert.assertEquals( json.getInt("totalprice"), 893, "Total price is not matching"  );
        softAssert.assertEquals( json.getBoolean("depositpaid"), false, "Deposit paid is not matching" );
        softAssert.assertEquals( json.getString("bookingdates.checkin"), "2017-04-19", "Checkin date is not matching" );
        softAssert.assertEquals( json.getString("bookingdates.checkout"), "2020-03-21", "Checkout date is not matching" );
